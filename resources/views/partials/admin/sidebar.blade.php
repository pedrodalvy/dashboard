...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ \Request::is('admin/resume/profile*') ? 'active' : '' }}">
    ...
    <li class="nav-item {{ \Request::is('admin/resume/experience*') ? 'active' : '' }}">
    ...
    <li class="nav-item {{ \Request::is('admin/resume/education*') ? 'active' : '' }}">
