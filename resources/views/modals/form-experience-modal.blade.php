                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm mb-0" id="job_title" name="job_title"
                                    placeholder="Informe a função exercida">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm mb-0" id="date_out" name="date_out" 
                                    placeholder="00/0000">
                            </div>
                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" id="job_resume" name="job_resume" rows="3"></textarea>
                              </div>
                        </div>
                    </div>
                </form>
